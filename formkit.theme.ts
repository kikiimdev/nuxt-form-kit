...
/**
  ...
  *
  * @checksum - 75d947d0b6fbdb841418327523ac31fe99f8dbc7ae0d8fdb2489151a9bfabbbe
  * @variables - radius=rounded-md,accentColor=blue,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow-none,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "file__inner": {
    "relative": true,
    "cursor-pointer": true,
    "group-data-[has-multiple]:rounded-md": true
  },
  "file__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
